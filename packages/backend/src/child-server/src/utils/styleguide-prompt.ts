...
export const getButtonPrompt = () => {
  return `
    ...
    1. **Primary Button**:
       ...
       - The button must always use \`paddingX: "20px"\`, \`paddingY: "12px"\`, \`fontSize: "11px"\`, \`borderColor: "HEX border color from style guide or none"\`, and \`borderWidth: "0px"\`.
    ...
    3. **Outlined Button**:
       ...
       - The button must always use \`paddingX: "20px"\`, \`paddingY: "12px"\`, \`fontSize: "11px"\`, \`borderColor: "HEX border color"\`, and \`borderWidth: "2px"\`.
    ...
    4. **Ghost Button**:
       ...
       - The button must always use \`paddingX: "20px"\`, \`paddingY: "12px"\`, \`fontSize: "11px"\`, \`borderColor: "transparent"\`, and \`borderWidth: "1px"\`.
    ...
    ### Requirements:
    - All buttons must have \`paddingX: "20px"\`, \`paddingY: "12px"\`, \`fontSize: "11px"\`, \`borderColor\`, and \`borderWidth\` where applicable.
...

    {
      "primary": {
        "css": {
          "fontSize": "11px",
          "borderRadius": "CSS border-radius here",
          "paddingX": "20px",
          "paddingY": "12px",
...

    {
      "textFieldStyling": {
        "inputStyle": {
          ...
          "borderStyle": "solid",
          "borderRadius": "Border radius based on input field example",
          "position": "relative",
  ...
  return `
...

    {
      "toggle": {
        ...
        "borderRadius": "border radius of the toggle button (e.g., 45%)"
      }
    }
    ...
    Return a JSON object with the following structure:
    {
      "checkBox": {
        "checkboxBaseStyles": {
          ...
          "width": "1.25rem",
          "cursor": "pointer",
          "borderRadius": "Use the value from the style guide if specified, otherwise use '0.125rem'"
        },
        "checkedStyles": {
          "border": "none",
